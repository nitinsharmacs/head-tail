...
const { validateOption } = require('../../src/tail/validators.js');
...
const { parseOption,
  ...
  createOption,
  isNotOption,
  createArgsIterator } = require('../../src/tail/parseArgs.js');
...
describe('parseOption', () => {
  ...
  it('should parse numerical option', () => {
    let argsIterator = createArgsIterator(['-4']);
    assert.deepStrictEqual(parseOption(argsIterator), {
      '-n': '-4',
    });
    argsIterator = createArgsIterator(['+4']);
    assert.deepStrictEqual(parseOption(argsIterator), {
      '-n': '+4',
    });
  });
